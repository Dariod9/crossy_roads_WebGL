...
lightSources[0].setPosition( -1.0, 2.0, 1.0, 0.0 );

lightSources[0].setIntensity( 1.0, 1.0, 0.3 );
...
//2
// lightSources[1].setPosition( 0.5, 2.0, -1.0, 0.0 );
...
// lightSources[1].setRotationSpeed( 1.0 );
...
lightSources[1].setIntensity( 0.5, 0.5, 0.8 );
